...
import {
    ChevronDown,
    ChevronRight,
    LucideIcon, MoreHorizontal, Plus, Trash
} from "lucide-react";
...
export const Item = ({
    ...
    const onArchive = (
        ...
        toast.promise(promise, {
            loading: "Перемещаем записку в корзину...",
            success: "Записка перемещна в корзину!",
    ...
    const onCreate = (
        ...
        toast.promise(promise, {
            ...
            error: "Не удалось сделать заметку.",
        });
    };
                    ...
                    <DropdownMenu>
                        ...
                        >
                            ...
                            <div className="text-xs text-muted-foreground p-2">
                                Последние изменения делал(а): {user?.fullName}
                            </div>
                        </DropdownMenuContent>
                    </DropdownMenu>
                    <div
